...
function PeopleView() {
    ...
    this.constructUsersListUrl = constructUsersListUrl;
    this.getAgeValues = getAgeValues;
    this.getCurrentMessage = getCurrentMessage;
    this.getValueByParameterName = getValueByParameterName;
    this.getSelectedCountryId = getSelectedCountryId;
    this.onSuccessCreateDialog = onSuccessCreateDialog;
    this.removeFromFriendsInMarkup = removeFromFriendsInMarkup;
    this.setPeopleSearchMode = setPeopleSearchMode;
    this.setFriendsSearchMode = setFriendsSearchMode;
                 ...
                 "<tr id='" + data[i].UserID + "'>" +
                     "<td>" +
                         "<a href='/main/mainpage/" + data[i].UserID + "'  >" +
                             "<img src='" + ROOT + data[i].ImageUrl + "' width='100px' height='100px' />" +
                         "</a>" +
                     "</td>" +
                     "<td>" +
                         "<a href='/main/mainpage/" + data[i].UserID + "' >" +
