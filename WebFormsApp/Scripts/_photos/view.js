...
PhotosView.prototype = function () {

    return {
        addPhotoTemplate: addPhotoTemplate, 
        changeColor: changeColor,
        closeModalWindow: closeModalWindow,
        createAlbumForm: createAlbumForm,
        createAlbumPanel: createAlbumPanel,
        editPhotoTemplate: editPhotoTemplate,
        generateGalleryMarkup: generateGalleryMarkup,
        getAllAlbumsPanel: getAllAlbumsPanel,
        getChangedPhotos: getChangedPhotos,
        getPhotoCheckedToDelete: getPhotoCheckedToDelete, 
        getPhotoAlbumInfo: getPhotoAlbumInfo,
        getLoadedImage: getLoadedImage,
        multiDownload: multiDownload,
        notificationAboutDeleting: notificationAboutDeleting,
        notificationAboutAddingToMainAlbum: notificationAboutAddingToMainAlbum,
        notificationAboutAddingToAlbum: notificationAboutAddingToAlbum, 
        showPhotoAlbums: showPhotoAlbums,
        showAlbumsCount: showAlbumsCount,
