...
function getUsers() {
    ...
    if (name != "")
        url = 'webapi/people/GetUsersList/' + from + '/' + to + '/' + country + '/' + town + '/' + UserID + '/' + gender + '/' + name + '/' + online;

    else
        url = 'webapi/people/GetUsersList/' + from + '/' + to + '/' + country + '/' + town + '/' + UserID + '/' + gender + '/' + online;
            ...
            if (data != null) {
                for (var i = 0; i < data.length; i++) {
                    ...
                    rows +=
                     ...
                     "<tr id='" + data[i].UserID + "'>" +
                         "<td>" +
                             "<a href='main.aspx?userid=" + data[i].UserID + "'  >" +
