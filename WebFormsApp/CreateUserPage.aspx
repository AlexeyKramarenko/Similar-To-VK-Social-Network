<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateUserPage.aspx.cs" Inherits="WebFormsApp.CreateUserPage" %>
...
<asp:Content ID="innerContent" ContentPlaceHolderID="PlaceHolder" runat="server">
    <div style="display: block; width: 650px; margin-left: auto; margin-right: auto;">
        ...
        <asp:FormView runat="server"
            ...
            ItemType="WebFormsApp.ViewModel.CreateUserViewModel">
                ...
                <fieldset>
                    ...
                    <div class="form-bottom">
                        <div class="form-group">
                            ...
                            <select id="Country" onchange='vm.getTowns()' class="dwellingPlace" name="Country">
                            </select>
                    ...
                    <div class="form-bottom">
                        <div class="form-group">
                            ...
                            <asp:DropDownList
                                ...
                                <asp:ListItem Value="Male" Text="мужской" />
                                <asp:ListItem Value="Female" Text="женский" />
                            </asp:DropDownList>
                        </div>
                        <div class="form-group">
                            ...
                            <asp:DropDownList
                                ID="ddlMaritalStatus"
                                runat="server"
                                SelectedValue='<%# BindItem.MaritalStatus %>'>
                                <asp:ListItem Value="Single" Text="не женат/не замужем" />
                                <asp:ListItem Value="Married" Text="женат/замужем" />
                            </asp:DropDownList>
                        </div>
